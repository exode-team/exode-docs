...
```
PUT /saas/v2/form/layout/:layoutId/update
```
...
<ParamField body="slug" type="string" required={false}>
  Символьный код макета. От 1 до 50 символов. Должен быть уникальным в рамках продавца (школы).
</ParamField>
...
Конфигурация.Вставить("resubmitMode", "NotAllowed");

Данные = Новый Структура;
Данные.Вставить("name", "Обновлённое название");
...
Запрос = Новый HTTPЗапрос("/saas/v2/form/layout/5/update");
...
```
```json Error - Layout Not Found / Not Owned
{
  "code": 401,
  "success": false,
  "cause": "Forbidden",
