...
```json Error - Not allowed key
{
  "code": 401,
  "success": false,
  "cause": "Unauthorized",
  "message": "Not allowed key VkFriends",
  "error": "Not allowed key VkFriends"
}
```
...
```json SET Error - Not allowed key
{
  ...
  "success": false,
  "cause": "Unauthorized",
  "message": "Not allowed key VkToken",
  "error": "Not allowed key VkToken"
}
```
</ResponseExample>
