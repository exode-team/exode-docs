---
title: "Поиск списком идентификаторов"
sidebarTitle: "Поиск нескольких"
...
<Tip>
    Нужно найти одного пользователя — используйте
    [Поиск по идентификатору](/ru/exode-api/school/user/find).
</Tip>
