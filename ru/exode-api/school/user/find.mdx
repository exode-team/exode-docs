...
<Tip>
    Нужно найти сразу несколько пользователей — используйте
    [Поиск списком идентификаторов](/ru/exode-api/school/user/find-many).
</Tip>
...
_Обновлено: 2026-08-05 14:14 UTC_
