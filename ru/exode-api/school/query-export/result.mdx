...
<ResponseField name="payload" type="object | null">
  Данные о прогрессе и результате генерации. Может быть `null`, если задача с таким `executionUuid` не найдена
  (например, срок хранения истёк).
  ...
  <Expandable title="Свойства payload">
    ...
    <ResponseField name="status" type="string">
      ...
      - `Waiting` — задача поставлена в очередь, ожидает выполнения
