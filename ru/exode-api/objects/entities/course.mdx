...
<Info>
    ...
    (`courseId`, `productId`, `name`, `type`, `groupIds`). Ниже — полные публичные схемы сущностей.
</Info>
...
<ResponseField name="description" type="string" required>Описание.</ResponseField>
<ResponseField name="questionMode" type="enum" required>Режим вопросов: `List`, `Sequence`.</ResponseField>
<ResponseField name="resultMode" type="enum" required>Режим результатов: `ResultOnly`, `ShowCorrect`, `ShowIncorrect`.</ResponseField>
<ResponseField name="variantMode" type="enum" required>Режим вариантов: `Random`, `Sequence`.</ResponseField>
<ResponseField name="retryVariantMode" type="enum" required>Режим вариантов при пересдаче: `Random`, `Sequence`.</ResponseField>
