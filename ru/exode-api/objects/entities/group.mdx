...
```json
{
  ...
  "order": 10,
  "maxMembers": 30,
  "communication": { "tgChannelId": null, "tgGroupChatId": null },
  "accessLimitation": { "active": true, "startPointType": "CommonDate" },
  "scheduleLimitation": { "active": false },
  "contentLimitation": { "active": false },
  "isTgConnected": false,
