...
<script src="https://cdn.exode.biz/sdk/v0.1.1/miniapp.global.js"></script>
```
...
<Info>
  В проде всегда фиксируйте версию (`v0.1.1`, `v0.2.0` и т. д.). Тег `latest` обновляется автоматически и может внести ломающие изменения.
</Info>
