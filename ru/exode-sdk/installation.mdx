...
<script src="https://static.exode.biz/sdk/v0.3.0/miniapp.global.js"></script>
...
<Info>
  В продакшене всегда фиксируйте версию (`v0.2.0`, `v0.3.0` и т. д.). Тег `latest` обновляется автоматически и может внести ломающие изменения.
</Info>
