...
<script src="https://static.exode.biz/sdk/v0.2.0/miniapp.global.js"></script>
...
<script src="https://static.exode.biz/sdk/latest/miniapp.global.js"></script>
...
<Info>
  В продакшене всегда фиксируйте версию (`v0.1.2`, `v0.2.0` и т. д.). Тег `latest` обновляется автоматически и может внести ломающие изменения.
</Info>
...
_Обновлено: 2026-07-24 12:29 UTC_
